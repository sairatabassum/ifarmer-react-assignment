...
const RoundStartModal: React.FC<RoundStartModalProps> = ({ round }) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                {
                    round > 1 && <div className="absolute -top-6 left-1/2 transform -translate-x-1/2 bg-primary text-background text-xs font-bold px-3 py-1 rounded-full shadow-md animate-pulse">
                        New Round!
                    </div>
                }
